-- https://github.com/wiiaboo/mpv-scripts/blob/master/subit.lua @ 91de7db43b21c6768c1f7089d3e8e2825453a8a4
...
function main()
    ...
    table.insert(t.args, "--addic7ed-fxcookies")
